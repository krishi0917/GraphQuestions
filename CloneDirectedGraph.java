package Graph;
/**
 * Created by rkhurana on 6/30/18.
 */
...
public class CloneDirectedGraph<T> {
    ...
    public Graph<T> clone(Graph<T> graph){
        ...
        Graph<T> clonedGraph = new Graph<T>(true);
    ...
    private void updateMap(Map<Vertex<T>, Vertex<T>> cloneMap, Vertex<T> cloneVertex,
    ...
    public static void main(String args[]){
        ...
        CloneDirectedGraph<Integer> cg = new CloneDirectedGraph<Integer>();
